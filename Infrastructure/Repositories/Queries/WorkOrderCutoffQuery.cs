...
internal class WorkOrderCutoffQuery
{
    internal static string GetQuery(string schema, string month)
    {
        ...
        '"", ""LastUpdated"" : ""' || TO_CHAR(wc.LAST_UPDATED, 'yyyy-mm-dd hh24:mi:sss') ||
        '"", ""CutoffWeek"" : ""' || wc.CUTOFFWEEK ||
        '"", ""CutoffDate"" : ""' || TO_CHAR(wc.CUTOFFDATE, 'yyyy-mm-dd hh24:mi:sss') ||
        '"", ""PlannedStartAtDate"" : ""' || TO_CHAR(wc.WOPLANNEDSTARTUPDATE, 'yyyy-mm-dd hh24:mi:sss')  ||
        '"", ""PlannedFinishedAtDate"" : ""' || TO_CHAR(wc.WOPLANNEDCOMPLETIONDATE, 'yyyy-mm-dd hh24:mi:sss')  ||
